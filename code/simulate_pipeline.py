...
if __name__ == "__main__":
    ...
    os.makedirs("E:/midea_papers/test_wav", exist_ok=True)
    sf.write("E:/midea_papers/test_wav/sim_test_0db.wav", noisy_0db, sr)
    sf.write("E:/midea_papers/test_wav/sim_test_neg5db.wav", noisy_neg5, sr)
